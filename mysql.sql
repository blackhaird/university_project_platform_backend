...
(
    ...
    mentor_Professional_id tinyint(2)                not null comment '导师职称(辅导员1 教师2 系副主任3 系主任4 副院长5 院长6)',
...
INSERT INTO student(student_id, student_name, student_sex, student_Admission_time, student_age, student_phone_number,
                    student_email, student_class)
VALUES (12240120002, '测试1', 1, '2024-03-02 19:30:00', 24, '10000000001', 'test@graduation', '计算机技术应用2班');
INSERT INTO student(student_id, student_name, student_sex, student_Admission_time, student_age, student_phone_number,
                    student_email, student_class)
VALUES (12240120003, '测试2', 1, '2024-03-02 19:30:00', 22, '10000000002', 'test@graduation', '计算机技术应用2班');
INSERT INTO student(student_id, student_name, student_sex, student_Admission_time, student_age, student_phone_number,
                    student_email, student_class)
VALUES (12240120004, '测试3', 1, '2024-03-02 19:30:00', 24, '10000000003', 'test@graduation', '计算机技术应用2班');
INSERT INTO student(student_id, student_name, student_sex, student_Admission_time, student_age, student_phone_number,
                    student_email, student_class)
VALUES (12240120005, '测试4', 2, '2024-03-02 19:30:00', 24, '10000000004', 'test@graduation', '大数据2班');
INSERT INTO student(student_id, student_name, student_sex, student_Admission_time, student_age, student_phone_number,
                    student_email, student_class)
VALUES (12240120006, '测试5', 2, '2024-03-02 19:30:00', 23, '10000000005', 'test@graduation', '大数据2班');
INSERT INTO student(student_id, student_name, student_sex, student_Admission_time, student_age, student_phone_number,
                    student_email, student_class)
VALUES (12240120007, '测试6', 2, '2024-03-02 19:30:00', 24, '10000000006', 'test@graduation', '大数据2班');
...
INSERT INTO user(user_name, user_password, user_Permission)
VALUES (12240120001, 123456, 2);
INSERT INTO user(user_name, user_password, user_Permission)
VALUES (12240120002, 123456, 2);
INSERT INTO user(user_name, user_password, user_Permission)
VALUES (12240120003, 123456, 2);
INSERT INTO user(user_name, user_password, user_Permission)
VALUES (12240120004, 123456, 2);
INSERT INTO user(user_name, user_password, user_Permission)
VALUES (12240120005, 123456, 2);
INSERT INTO user(user_name, user_password, user_Permission)
VALUES (12240120006, 123456, 2);
INSERT INTO user(user_name, user_password, user_Permission)
VALUES (12240120007, 123456, 2);
...
(
    ...
    mentor_id                bigint(11)                not null comment '创建者ID',
    ...
    project_done_status      tinyint(2)   default 0 comment '项目完成状态:进行中1,已结束2',
...
VALUES (31000000001, '一体化HPV检测仪器', '1.12.37.222/1.png',
        ...
        2,
        '2024-03-19 00:10:07', 'C:\\graduation\\一体化HPV检测仪器.doc', '11001000001', '生物、医药及医疗机械', 0,
        '生物学院', 1, NULL, '暂无', 0)
     , (31000000002, '一种面向金融风控的轻量型自动化机器学习(autoML）框架', '1.12.37.222/2.png',
        ...
        3,
        '2024-03-20 00:10:07', 'C:\\graduation\\一种面向金融风控的轻量型自动化机器学习（autoML）框架.doc', '11001000001',
     ...
     , (31000000003, '智能全景记录仪', '1.12.37.222/3.png',
        ...
        2,
        '2024-03-19 00:10:07', 'C:\\graduation\\智能全景记录仪.doc', '11001000002', '新一代信息技术', 0, '计算机学院',
        1, NULL, '暂无', 0)
     , (31000000004, '医学脑电智能诊断', '1.12.37.222/4.png',
        ...
        3,
        '2024-03-19 00:10:07', 'C:\\graduation\\医学脑电智能诊断.doc', '11001000002', '生物、医药及医疗机械', 0,
        '生物学院', 1, NULL, '暂无', 0)
     , (31000000005, '智慧城市管廊检测项目', '1.12.37.222/5.png',
        ...
        3,
        '2024-03-19 00:10:07', 'C:\\graduation\\智慧城市管廊检测项目.doc', '11001000003', '新一代信息技术', 0,
        '计算机学院', 1, NULL, '暂无', 0)
     , (31000000006, '全球领先的可再生电力CO2转化解决方案提供者', '1.12.37.222/6.png',
        '本项目在提出了一种利用水相及油相介质之间表面张力的选择性通过结构（可称为“介质阀”）的同时，将这种介质阀结构集成于微流控芯片，配合磁珠实现了对核酸纯化的目的。同时，本研究基于介质阀结构及LAMP扩增技术完成了一套完整的微流控芯片及自动化检测-扩增装置。',
        '本项目中所形成的方案能够有效解决当前核酸提取及扩增中操作繁琐，耗时长，需要借助大型设备，有毒性等问题。最终实现减小装置体积，缩短检测周期，增大通量，减少操作复杂度。传统的核酸纯化扩增检测方式不具有完善的自动化控制系统。相关装置外设庞大，耗时长。无法实现现场快速实时。为了克服上述问题，研发一种基于纳米磁珠以及磁控自动化的核酸纯化-扩增-检测一体化设备。小型一体化设备，能够简单快捷地检测，满足检测的现场化，快速化，实时化等要求。',
        2,
        '2024-03-19 00:10:07', 'C:\\graduation\\全球领先的可再生电力CO2转化解决方案提供者doc', '11001000003',
     ...
     , (31000000007, '一种智能化泡沫灭火除尘系统', '1.12.37.222/7.png',
        ...
        2,
        '2024-03-19 00:10:07', 'C:\\graduation\\一种智能化泡沫灭火除尘系统.doc', '11001000004', '新能源与节能环保', 0,
        '材料学院', 1, NULL, '暂无', 1)
     , (31000000008, '云遥宇航星座计划', '1.12.37.222/8.png',
        ...
        2,
        '2024-03-19 00:10:07', 'C:\\graduation\\云遥宇航星座计划.doc', '11001000004', '新一代信息技术', 0, '计算机学院',
        1, NULL, '暂无', 1)
     , (31000000009, '爬沙虫自动化立体养殖设备', '1.12.37.222/9.png',
        ...
        2,
        '2024-03-19 00:10:07', 'C:\\graduation\\爬沙虫自动化立体养殖设备.doc', '11001000011', '农业科技', 0, '生物学院',
        1, NULL, '暂无', 1)
     , (31000000010, '二维钙钛矿纳米材料用于光催化降解黑臭水体', '1.12.37.222/10.png',
        ...
        '2024-03-19 00:10:07', 'C:\\graduation\\二维钙钛矿纳米材料用于光催化降解黑臭水体.doc', '11001000011',
     ...
     , (31000000011, '基于Dijkstra算法的小区运输车的设计', '1.12.37.222/11.png',
        ...
        2,
        '2024-03-19 00:10:07', 'C:\\graduation\\基于Dijkstra算法的高精度物联网小区无人智能运输车的设计.doc',
     ...
     , (31000000012, '快照式光谱成像芯片', '1.12.37.222/12.png',
        ...
        '2024-03-19 00:10:07', 'C:\\graduation\\快照式光谱成像芯片： 交叉路口全息投影系统.doc', '11001000012',
     ...
     , (31000000013, '路口字节： 交叉路口全息投影系统', '1.12.37.222/13.png',
        ...
        2,
        '2024-03-19 00:10:07', 'C:\\graduation\\路口字节： 交叉路口全息投影系统.doc', '11001000013', '交通规划及运输', 1,
        '管理学院', 1, NULL, '暂无', 3)
     , (31000000014, '液体活检，开启精神分裂症精诊医学新时代', '1.12.37.222/14.png',
        ...
        2,
        '2024-03-19 00:10:07', 'C:\\graduation\\液体活检，开启精神分裂症精诊医学新时代.doc', '11001000013',
     ...
     , (31000000015, '千针万确-智能静脉穿刺采血机器人', '1.12.37.222/15.png',
        ...
        2,
        '2024-03-19 00:10:07', 'C:\\graduation\\千针万确-智能静脉穿刺采血机器人.doc', '11001000014', '新一代信息技术',
        1, '计算机学院', 1, NULL, '暂无', 3)
     , (31000000016, '锂电池分布式带电拆解', '1.12.37.222/16.png',
        ...
        2,
        '2024-03-19 00:10:07', 'C:\\graduation\\锂电池分布式带电拆解.doc', '11001000014', '新能源与节能环保', 1,
     ...
     , (31000000017, '青选至乡村茶农增收帮扶项目', '1.12.37.222/17.png',
        ...
        2,
        '2024-03-19 00:10:07', 'C:\\graduation\\青选至乡村茶农增收帮扶项目.doc', '11001000015', '农业科技', 1,
     ...
     , (31000000018, '全球甘蔗细胞水提取技术引领者', '1.12.37.222/18.png',
        ...
        2,
        '2024-03-19 00:10:07', 'C:\\graduation\\全球甘蔗细胞水提取技术引领者.doc', '11001000015', '农业科技', 1,
        '生物学院', 2, '2024-04-19 00:10:07', '暂无', 3)
     , (31000000019, '格镭智图——国际领先 国内首款 双旋轴激光扫描仪', '1.12.37.222/19.png',
        ...
        2, '2024-03-19 00:10:07', 'C:\\graduation\\格镭智图——国际领先 国内首款 双旋轴激光扫描仪.doc', '11001000016',
     ...
     , (31000000020, '绿黄金智慧环保', '1.12.37.222/20.png',
        ...
        2,
        '2024-03-19 00:10:07', 'C:\\graduation\\绿黄金智慧环保.doc', '11001000016', '新能源与节能环保', 1, '材料学院',
...
(
    ...
    competition_id                           bigint(11) comment '竞赛处id',
    Group_id                                 bigint(11) comment '小组编号',
    project_status_id                        TINYINT(3) not null default 2 comment '项目状态id 0代表未通过 1代表通过 2代表审核中 ',
    project_status_Description               varchar(50)         default null comment '项目状态状态描述 注释/备注'
...
create table student_Audit(
                              ...
                              student_audit_time        datetime            default now() comment '操作时间',
...
create table mentor_Audit(
                             mentor_audit_id int(10) primary key auto_increment,
                             mentor_id bigint(11) comment '老师id',
                             Competition_id bigint(11) comment '竞赛处id',
                             project_id bigint(11) comment '项目id',
                             group_id bigint(11) comment '举行的学生组id',
                             mentor_audit_time        datetime            default now() comment '操作时间',
                             mentor_audit_status tinyint(2)      default 2 comment '0:操作失败 1：操作成功 2：审核中',
                             mentor_audit_status_Description varchar(50)         default null comment '审核状态描述 注释/备注'
);
...
create table credits_audit(
                              ...
                              credits_audit_time        datetime            default now() comment '操作时间',
