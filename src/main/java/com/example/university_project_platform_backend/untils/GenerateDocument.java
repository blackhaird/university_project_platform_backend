...
public class GenerateDocument {
    ...
    public static void main(String[] args) {
        String fileOutputDir = "D:\\Work_RJ\\java_study\\university_project_platform_backend\\src\\main\\resources\\document";
    ...
    static void documentGeneration(String fileOutputDir) {
        ...
        hikariConfig.setJdbcUrl("jdbc:mysql://1.12.37.222:3306/university_project_platform_db");
